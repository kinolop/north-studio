        ...
        <div className="mt-20 grid gap-5 lg:grid-cols-3">
          {trust.items.map((item, index) => (
            <Reveal key={item.key} delay={index * 0.08} className="h-full">
              <article className="group flex h-full flex-col rounded-[var(--radius-plate)] border border-orbita/20 bg-[linear-gradient(180deg,rgb(13_58_68/0.28),rgb(7_8_11/0.6))] p-7 transition-[transform,border-color] duration-[520ms] ease-[var(--ease-north)] hover:-translate-y-1 hover:border-orbita/45 lg:p-8">
