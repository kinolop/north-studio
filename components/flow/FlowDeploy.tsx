...
const meta = flowSectionById("flow-deploy");

/**
 * Four short facts about getting the line running. A row of hairline cells
 * rather than cards, matching the agent case: this is reassurance after the
 * demonstration, not a second pitch, and it should read quickly and then get
 * out of the way.
 */
export function FlowDeploy() {
  const copy = useCopy();
  const deploy = copy.flowCase.deploy;
